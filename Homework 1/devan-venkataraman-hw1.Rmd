...
**This plot above shows how the standard deviation, or the expected error from a given experiment, of the sample means decreases with larger sample sizes.**
...
**The histograms above show that as the number of random values taken from the uniform distribution increases, the sum of those values quickly approximates the normal distribution. For this reason, the example supports the Central Limit Theorum.**
...
**The sample mean will approach some constant, based on the arbitrary distribution measurements are taken from. As N (the number of measurements taken) increases, the standard deviation of this sample will decrease.**
